export const personalData = {
  ...
  education: [
    "Intermediate in Computer Science,Concordia Mistake Garden Town Lahore(2021-2023)",
    "Bachelor of Science in Computer Science, University of Lahore(2024-continue)",
  ],
  contactLinks: [
    "mailto:emailto:muhammadraffey26@gmail.com",
    "https://twitter.com/MuhammadRaffey",
    "https://www.linkedin.com/in/muhammad-raffey-b94b54289/",
  ],
};
